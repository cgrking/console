...
//DTO data transfer object, VO, model
public class RouteInfoItem {
	private String busRouteId;
	private String busRouteNm;
	private String deStationNm;
	...
	public String getDeStationNm() {
		return deStationNm;
	}
	public void setDeStationNm(String deStationNm) {
		this.deStationNm = deStationNm;
	}
